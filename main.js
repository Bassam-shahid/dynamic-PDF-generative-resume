...
(_b = document.getElementById('form1')) === null || _b === void 0 ? void 0 : _b.addEventListener('submit', function (event) {
    var _a;
    event.preventDefault(); // Page reload hone se roknay ke liye
    ...
    if (profilePictureInput && nameElement && emailElement && phoneElement &&
        ...
        var profilePictureURL = profilePictureFile ? URL.createObjectURL(profilePictureFile) : '';
        // Create resume output HTML
        var resumeOutput = "\n            <h2>Resume</h2>\n            ".concat(profilePictureURL ? "<img src=\"".concat(profilePictureURL, "\" alt=\"Profile Picture\" class=\"profilepicture\">") : '', "\n            <p><strong>Name:</strong> ").concat(name_2, "</p>\n            <p><strong>Email:</strong> ").concat(email, "</p>\n            <p><strong>Phone Number:</strong> ").concat(phone, "</p>\n\n            <h3>Education</h3>\n            <p>").concat(education, "</p>\n\n            <h3>Work Experience</h3>\n            <p>").concat(experience, "</p>\n\n            <h3>Skills</h3>\n            <p>").concat(skills, "</p>\n        ");
        ...
        if (downloadButton) {
            ...
            downloadButton.addEventListener('click', function () {
                ...
                if (element) {
                    html2pdf().from(element).save('Resume.pdf'); // Generate PDF and download
                }
            });
        }
    }
